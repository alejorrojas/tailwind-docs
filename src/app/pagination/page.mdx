...
In this guide, we gonna look at how to work wit paginated response whin querying da Protocol API. By default, all responses limit result to ten. However, u can go as high as 100 by addin a `limit` parameter 2 ur requests. If your using one of da official Protocol API client libraries, u dont need 2 worry bout pagination, as its all being took care of behind da scenes. {{ className: 'lead' }}
